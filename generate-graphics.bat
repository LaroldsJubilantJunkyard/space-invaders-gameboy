...
%GBDK_HOME%/bin/png2asset graphics\sprites\BulletA.png -c source\gen\default\graphics\BulletA.c -sw 8 -sh 16 -spr8x8
%GBDK_HOME%/bin/png2asset graphics\sprites\BulletB.png -c source\gen\default\graphics\BulletB.c -sw 8 -sh 16 -spr8x8
%GBDK_HOME%/bin/png2asset graphics\sprites\BulletC.png -c source\gen\default\graphics\BulletC.c -sw 8 -sh 16 -spr8x8
